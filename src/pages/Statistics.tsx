...
import { printOutline, refreshOutline, arrowBackOutline } from "ionicons/icons";
      ...
      <IonContent fullscreen>
        {loading ? (
          ...
          <>
            ...
            >
              <ChartCard title="Submissions per Barangay">
              ...
              <ChartCard title="GreenPoints Distribution">
                <ResponsiveContainer width="100%" height={250}>
              ...
              <ChartCard title="Tree Conditions">
                <ResponsiveContainer width="100%" height={250}>
                  <PieChart>
                    <Pie
                      data={pieData}
              ...
              <ChartCard title={`User Logins (${logFilter})`}>
                <ResponsiveContainer width="100%" height={250}>
              ...
              <ChartCard title="Events Created Over Time">
                <ResponsiveContainer width="100%" height={250}>
