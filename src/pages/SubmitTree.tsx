      ...
      .insert([
        {
          ...
          // No submission_id provided, let DB generate or handle manually
        },
      ])
      .select("submission_id"); // ✅ select the correct primary column

    if (dbErr) throw dbErr;

    // Optional: get the newly inserted submission_id
    const submissionId = dbData?.[0]?.submission_id;
